...
- [Solution 1](./solution_01.md): This approach manually parses the string to collect words, reverses their order, and joins them with a single space. It has a time complexity of O(n) and space complexity of O(n).

...
- [Solution 1](solution_01.md) - This approach uses a combination of a list and a dictionary to achieve average O(1) time complexity for insert, remove, and getRandom operations.
